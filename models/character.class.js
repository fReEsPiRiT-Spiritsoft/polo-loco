class Character extends MoveableObject {
    ...
    animate() {
        setInterval(() => {
            ...
            if (this.world.keyboard.RIGHT && this.x < 7200 && !this.isDead() && !this.characterKnockbackActive) {
                this.moveRight()
                this.otherDirection = false;
                moved = true;
            }
            if (this.world.keyboard.LEFT && this.x > 0  && !this.isDead() && !this.characterKnockbackActive) {
                this.moveLeft();
